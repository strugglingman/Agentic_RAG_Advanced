param(
    [string]$TemplateFile = "config/eks/eks_cloudwatch_observability_pod_identity_association.template.json",
...
$outputPath = Join-Path $repoRoot "config/eks/eks_cloudwatch_observability_pod_identity_association.from_local.json"
